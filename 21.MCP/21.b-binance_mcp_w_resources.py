# Otra forma de arrancar el inspector:
# mcp dev 21.MCP/21.b-binance_mcp_w_resources.py
...
# Un resource puede tener parámetros.
# En este caso se usa la tool get_price como resource.
